...
{
	public class NotificationVettingBatchResultsNotifiedWithRejections_Item : INotificationVettingBatchResultsNotifiedWithRejections_Item
	{
		...
		public List<NotificationRejectedParticipant_Item> RejectedParticipants { get; set; }
