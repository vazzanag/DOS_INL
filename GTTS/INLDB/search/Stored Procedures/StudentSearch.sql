CREATE PROCEDURE [search].[StudentSearch]
...
BEGIN
    ...
    */
    SELECT MAX([Rank]) AS [Rank], PersonID, FirstMiddleNames, LastNames, AgencyName, AgencyNameEnglish, 
           UnitName, UnitNameEnglish, CountryName, CAST(FORMAT ( DOB, 'd', 'en-US' ) AS NVARCHAR(15)) DOB,
           Gender, JobTitle, JobRank, VettingStatus, VettingStatusDate, VettingType, Distinction
      FROM (
		        SELECT r.[Rank], PersonID, FirstMiddleNames, LastNames, i.UnitName, i.UnitNameEnglish,
                       a.UnitName AS AgencyName, a.UnitNameEnglish AS AgencyNameEnglish, CountryName, i.DOB, i.Gender, i.JobTitle,
                       i.JobRank, i.VettingStatus, i.VettingStatusDate, i.VettingType, i.Distinction
		          FROM search.StudentsView i
  ...
  GROUP BY PersonID, FirstMiddleNames, LastNames, AgencyName, AgencyNameEnglish, 
           UnitName, UnitNameEnglish, CountryName, DOB, Gender, JobTitle, JobRank, VettingStatus, VettingStatusDate, VettingType, Distinction
