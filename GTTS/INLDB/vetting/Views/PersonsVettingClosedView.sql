CREATE VIEW [vetting].[PersonsVettingClosedView]
AS
...
LEFT JOIN persons.PersonsUnitLibraryInfoView u ON pv.PersonsUnitLibraryInfoID = u.PersonsUnitLibraryInfoID and u.IsActive = 1
...
-- Only bathes CLOSED = finished
WHERE b.VettingBatchStatusID = 8 -- CLOSED
AND s.Code='APPROVED' OR s.Code = 'REJECTED' OR s.Code = 'SUSPENDED'
