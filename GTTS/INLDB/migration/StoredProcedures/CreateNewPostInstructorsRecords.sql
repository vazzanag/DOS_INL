/*
    NAME:   CreateNewPostInstructorsRecords
    
    DESCR:  This Stored Procedure receives 1 parameter and then inserts the 
            data from the [ImportInstructors] table into a new record in the 
            [NewPostInstructors] table.
*/
CREATE PROCEDURE [migration].[CreateNewPostInstructorsRecords]
...
BEGIN
    ...
    BEGIN TRY
        BEGIN TRANSACTION
            ...
            -- INSERT NEW RECORD
            INSERT INTO [migration].[NewPostInstructors]
            (   [NewPostImportID],
                [FirstMiddleName],
                [LastName],
                [NationalID],
            ...
            SELECT 
                ...
                'Uploaded',
                2
            FROM [migration].[ImportInstructors] imp;
