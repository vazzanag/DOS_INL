${
    ...
    {
        settings.IncludeProject("INL.TrainingService.Models");
        settings.IncludeProject("INL.PersonService.Models");
...
$Classes(INL.PersonService.Models.PersonLanguage_Item)[
$ClassImports
export class $Name $Implements {
  $CustomClassProperties
  $BaseClass[$CustomClassProperties]
}]
$Interfaces(INL.PersonService.Models.IPersonLanguage_Item)[
$InterfaceImports
export interface $Name {
  $CustomInterfaceProperties
}]
