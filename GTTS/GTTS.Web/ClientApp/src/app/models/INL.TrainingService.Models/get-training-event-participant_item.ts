...
import { IGetTrainingEventParticipant_Item } from './iget-training-event-participant_item';

export class GetTrainingEventParticipant_Item implements IGetTrainingEventParticipant_Item {
