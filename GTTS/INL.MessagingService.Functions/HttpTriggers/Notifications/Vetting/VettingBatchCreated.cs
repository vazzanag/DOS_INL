...
{
    public static class VettingBatchCreated
	{
        [FunctionName("VettingBatchCreated")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "notifications/vettingbatchcreated")]HttpRequestMessage request,
            ILogger log,
            ...
            using (log.BeginScope(context.InvocationId.ToString()))
            {
                ...
                try
                {
                    ...
                    using (var sqlConnection = await helper.GetSqlConnectionAsync())
                    {
                        ...
                        result = messagingService.CreateVettingBatchCreatedNotification(vettingBatchCreatedParam, helper.GTTSWebsiteURL, 
