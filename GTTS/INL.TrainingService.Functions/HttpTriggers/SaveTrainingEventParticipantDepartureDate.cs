...
{
    public static class SaveTrainingEventParticipantDepartureDate
    {
        [FunctionName("SaveTrainingEventParticipantDepartureDate")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "trainingevents/{trainingeventid}/participants/{personid}/departuredate")]HttpRequestMessage request, long trainingEventID, long personID, ILogger log, Microsoft.Azure.WebJobs.ExecutionContext context)
        {
