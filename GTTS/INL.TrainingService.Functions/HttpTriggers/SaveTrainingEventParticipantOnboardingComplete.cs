...
{
    public static class SaveTrainingEventParticipantOnboardingComplete
    {
        [FunctionName("SaveTrainingEventParticipantOnboardingComplete")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "trainingevents/{trainingeventid}/participants/{personid}/onboardingcomplete")]HttpRequestMessage request, long trainingEventID, long personID, ILogger log, Microsoft.Azure.WebJobs.ExecutionContext context)
        {
